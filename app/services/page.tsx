          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="w-full opacity-80 p-8 text-[#7B5B4C] shadow-sm bg-white rounded-lg">
              ...
              <div className="flex items-center mb-4">
                ...
                <h1 className="text-xl md:text-2xl font-bold leading-tight text-left">
                  {t("service.cards.cardOne.title")}
                </h1>
              </div>
              <p className="text-sm md:text-lg mb-6 text-justify">
                {t("service.cards.cardOne.textOne")}
              </p>
              <p className="text-sm md:text-lg mb-6 text-justify">
                {t("service.cards.cardOne.textTwo")}
              </p>
            </div>
            ...
            <div className="w-full opacity-80 p-8 text-[#7B5B4C] shadow-sm bg-white rounded-lg">
              ...
              <div className="flex items-center mb-4">
                ...
                <h1 className="text-xl sm:text-2xl font-bold leading-tight text-left">
                  {t("service.cards.cardTwo.title")}
                </h1>
              </div>
              <p className="text-sm md:text-lg mb-6 text-justify">
                {t("service.cards.cardTwo.textOne")}
              </p>
              <p className="text-sm md:text-lg mb-6 text-justify">
                {t("service.cards.cardTwo.textTwo")}
              </p>
            </div>
            ...
            <div className="w-full opacity-80 p-8 text-[#7B5B4C] shadow-sm bg-white rounded-lg">
              ...
              <div className="flex items-center mb-4">
                ...
                <h1 className="text-xl sm:text-2xl font-bold leading-tight text-left">
                  {t("service.cards.cardThree.title")}
                </h1>
              </div>
              <p className="text-sm md:text-lg mb-6 text-justify">
                {t("service.cards.cardThree.text")}
              </p>
            </div>
          </div>
        </div>
