      ...
      >
        <div className="lg:mr-[300px] w-[322px] sm:w-[400px] mx-auto bg-white opacity-72 p-8 text-[#7B5B4C] h-[450px] sm:h-[484px]">
          ...
          <p className="text-md md:text-lg mb-6 text-left">
            Specialist in customized accommodation solutions for companies throughout Sweden
          </p>
          <p className="text-md md:text-lg mb-6 text-left">
            Is your company looking for accommodation for a longer construction project or a shorter assignment?
          </p>
        </div>
      </section>
      ...
      <div className="flex flex-col lg:flex-row mx-auto p-10 sm:px-6 lg:px-8">
        ...
        <div className="lg:w-1/2 w-full p-6 rounded-lg shadow-lg">
          ...
          <div className="flex items-center mb-4">
            ...
            <p className="text-[#7B5B4C]">For direct contact, call us at <a href="tel:+46103333536" className="underline">+46 10-333 35 36</a></p>
          </div>
          <div className="flex items-center mb-4">
            <Mail className="text-[#7B5B4C] mr-2" />
            <p className="text-[#7B5B4C]">We respond to emails within 24 hours. You can reach us at <a href="mailto:kontakt@stayspace.se" className="underline">kontakt@stayspace.se</a></p>
          </div>
          <div className="flex items-center mb-4">
          ...
          <div className="flex items-center mb-4">
            <Phone className="text-[#7B5B4C] mr-2" />
            <p className="text-[#7B5B4C]">Phone: <a href="tel:+46103333536" className="underline">+46 10-333 35 36</a></p>
          </div>
        </div>
      </div>
    </div>
